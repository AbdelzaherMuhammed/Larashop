                ...
                <form action="{{url('/place-order')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <span style="color:red">{{ $errors->first('full_address') }}</span>
                        </div>
                                    ...
                                    <div class="cart-row">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 text-center">
                                                <img src="{{asset('images')}}/{{$record->options->image}}"
                                                     class="img-responsive pull-left" width="100px" />
                                                <span class="pull-left top20">
                                      <a href="{{url('details')}}/{{$record->id}}">
                                          <b>{{ucwords($record->product_name)}}</b>
                                        </a>
                                      </span>

                                            </div>
                                            <div class="col-xs-12 col-sm-3 col-md-3">
                                                <input type="hidden" value="{{$record->rowId}}"
                                                       id="rowID{{$record->id}}"/>
